...
const labelCls = 'text-[10px] font-bold uppercase tracking-widest text-base-400 dark:text-base-300/80 mb-1 block';
        ...
        <>
            ...
            <Dialog open={activeModal === 'view'} fullWidth maxWidth="md" onClose={closeModal} sx={dialogSx}>
                ...
                <DialogTitle className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] font-mono text-base-400 -mt-0.5">{selectedOrder.orderId}</p>
                        </div>
                    </div>
                ...
                <DialogContent dividers sx={{ px: 0, py: 0 }}>
                    ...
                    <div className="p-5 space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="rounded-xl border border-base-100 dark:border-white/6 bg-base-50 dark:bg-base-800/40 p-4">
                                ...
                                <div className="space-y-2 mt-2">
                                    ...
                                    <p className="text-[12px] text-base-500 dark:text-base-400">{selectedOrder.shipping?.email}</p>
                                    <p className="text-[12px] text-base-500 dark:text-base-400">{selectedOrder.shipping?.phone}</p>
                            ...
                            <div className="rounded-xl border border-base-100 dark:border-white/6 bg-base-50 dark:bg-base-800/40 p-4">
                                ...
                                <div className="space-y-2 mt-2">
                                    ...
                                    <div className="flex justify-between text-[13px] pt-1 border-t border-base-100 dark:border-white/5 mt-1">
                                        ...
                                        <span className="font-extrabold text-emerald-600 dark:text-emerald-400">₹{fmt(selectedOrder.pricing?.total)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 text-[11px] text-base-400 dark:text-base-500">
                            <span>Placed: <span className="font-semibold text-base-600 dark:text-base-300">{fmtDate(selectedOrder.placedAt)}</span></span>
                            <span className="text-base-200 dark:text-base-700">·</span>
                            <span>User ID: <span className="font-mono text-base-500">{selectedOrder.userId}</span></span>
                        </div>
                    </div>
                ...
                <DialogActions sx={{ px: 2.5, pb: 2.5, pt: 1.5, gap: 1.5 }}>
                    ...
                    <Button variant='dark' sx={{ py: 1.1 }} onClick={closeModal} disabled={saving} >Close</Button>

                    {/* <Button variant="contained" 
                        className='bg-accent-gradient hover:shadow-accent!'
                        onClick={() => { closeModal(); setTimeout(() => onStatusUpdate?.('_open_status_' + selectedOrder._id), 100); }}
            ...
            <Dialog open={activeModal === 'status'} fullWidth maxWidth="xs" onClose={closeModal} sx={dialogSx}>
                ...
                <DialogActions sx={{ px: 2.5, pb: 2.5, pt: 1.5, gap: 1.5 }}>
                    ...
                    <Button variant="dark" onClick={closeModal} sx={{ py: 1.1 }} disabled={saving}>
                        Cancel
                    </Button>
            ...
            <Dialog open={activeModal === 'delete'} slots={{ transition: ZoomTransition }} keepMounted fullWidth maxWidth="xs" onClose={closeModal} sx={dialogSx}>
                ...
                <DialogContent sx={{ textAlign: 'center', py: 4, px: 3 }}>
                    ...
                    <IconButton onClick={closeModal} sx={{ position : "absolute", top : 16, right :16 }} size="small"><X size={20} /></IconButton>
                    ...
                    <div className="flex items-center gap-2.5 my-4 px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-base-800 border border-base-100 dark:border-white/6 text-left">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="font-extrabold text-[13px] text-base-800 dark:text-base-100 truncate">{selectedOrder.orderId}</p>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button fullWidth variant="dark" onClick={closeModal} sx={{ py: 1.1 }} disabled={saving}>
                            Cancel
                        </Button>
